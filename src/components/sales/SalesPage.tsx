...
export function SalesPage({
  ...
  return (
    <main className="animate-rise-in overflow-hidden bg-white pb-24 text-zinc-900 selection:bg-red-600 selection:text-white sm:pb-32">
      ...
      {/* Hero / Video Section */}
      <section className="relative bg-white px-5 pb-8 pt-4 text-center text-zinc-950 sm:pb-28 sm:pt-20 min-h-[calc(100dvh-52px)] flex flex-col justify-center">
        ...
        <div className="relative mx-auto max-w-6xl w-full flex flex-col items-center">
          <div className="mb-4 inline-flex rounded-full border border-red-100 bg-red-50 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.2em] text-red-600 sm:mb-10 sm:px-4 sm:py-2 sm:text-[11px]">
            Acesso Liberado com Desconto
          </div>
          <h2 className="mx-auto mb-6 max-w-4xl text-3xl font-black uppercase leading-[1.1] tracking-[-0.055em] text-zinc-950 sm:mb-12 sm:text-7xl">
          ...
          <div className="mx-auto max-w-3xl space-y-6 sm:space-y-7">
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-6">
              ...
              <CTAButton
                ...
                className="w-full rounded-xl bg-green-500 py-4 text-sm font-black uppercase tracking-tight shadow-[0_20px_50px_-10px_rgba(34,197,94,0.3)] hover:bg-green-600 sm:w-auto sm:rounded-2xl sm:px-8 sm:py-5 sm:text-lg animate-pulse-subtle"
              />
              
              <div className="flex items-center gap-2 text-[10px] font-bold text-zinc-400 uppercase tracking-widest sm:text-xs">
                <ShieldCheck className="h-3.5 w-3.5 text-green-500 sm:h-4 sm:w-4" /> Pagamento 100% Seguro
              </div>
            </div>
          </div>
        </div>
