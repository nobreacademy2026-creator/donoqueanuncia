    ...
    return (
      <div className="animate-rise-in mx-auto w-full max-w-2xl px-4 sm:px-0 flex flex-col min-h-[calc(100dvh-20px)] justify-center">
        <div className="mt-1 space-y-2 text-center bg-white rounded-2xl p-2.5 sm:space-y-8 sm:p-8 sm:rounded-3xl">
          ...
          <div className="relative mx-auto max-w-md overflow-hidden rounded-xl border border-zinc-100 bg-[#f0f2f5] p-1.5 shadow-sm sm:rounded-2xl sm:p-4">
          ...
          <div className="space-y-3 sm:space-y-6">
            <div className="relative mx-auto w-full max-w-[150px] sm:max-w-sm">
              <img
                ...
                loading="lazy"
                decoding="async"
                className="w-full h-auto rounded-2xl shadow-xl border border-zinc-100 animate-pulse-subtle sm:rounded-3xl sm:shadow-2xl"
              />
            </div>
            ...
            <button
              ...
              className="bg-[#22c55e] hover:bg-[#16a34a] inline-flex w-full items-center justify-center gap-2 rounded-xl px-6 py-2.5 text-xs font-black text-white transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] shadow-md shadow-green-600/10 uppercase animate-pulse-subtle sm:px-8 sm:py-4 sm:text-base"
            >
