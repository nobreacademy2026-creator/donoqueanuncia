        ...
        handlers: {
            ...
            POST: async ({ request }) => {
                ...
                try {
                    ...
                    const customerIp = body.customer_ip ||
                        body.ip ||
                        body.data?.ip ||
                        body.client_ip ||
                        body.data?.client_ip ||
                        body.data?.customer_ip;
                    const customerUserAgent = body.user_agent ||
                    ...
                    else if (rawStatus.includes("aprovada") ||
                    ...
                    if (rawStatus.includes("printed") || rawStatus.includes("boleto"))
                        friendlyStatus = "boleto_printed";
                    else if (rawStatus.includes("pix") || rawStatus.includes("gerado"))
                        friendlyStatus = "pix_generated";
                    else if (rawStatus.includes("aguardando"))
                        friendlyStatus = "waiting_payment";
                    else if (rawStatus.includes("aprovada") ||
                        rawStatus.includes("pago") ||
                        rawStatus.includes("paid") ||
                        rawStatus.includes("approved") ||
                    ...
                    else if (rawStatus.includes("abandon") || rawStatus.includes("abandonado"))
                        friendlyStatus = "abandoned_checkout";
                    else if (rawStatus.includes("refund") || rawStatus.includes("reembolso"))
                        friendlyStatus = "refunded";
                    else if (rawStatus.includes("chargeback"))
                        friendlyStatus = "chargeback";
                    else if (rawStatus.includes("cancel"))
                        friendlyStatus = "subscription_canceled";
                    // Extrair UTMs
